...
public sealed class Ui
{
    ...
    private static readonly Dictionary<string, string> En = new()
    {
        ...
        ["Dauerhaft"] = "Permanent",
        ["Läuft in {0} Tagen ab"] = "Expires in {0} days",
        ...
        ["Aufbewahrung:"] = "Retention:",
        ["Läuft ab am {0}"] = "Expires on {0}",
        ["Verlängert bis {0}"] = "Extended until {0}",
        ["Dauerhaft aufbewahren"] = "Retain permanently",
        ["Um ein Jahr verlängern"] = "Extend by one year",
        ["Ausnahme aufheben"] = "Lift exception",
        ["Der Einwilligungsnachweis bleibt unabhängig davon erhalten."] = "The consent proof is kept independently of this.",
        ["Bearbeitung:"] = "Handling:",
        ["Werte"] = "Values",
        ...
        ["Abschlussquote (Einsendungen / begonnen, {0})"] = "Completion rate (submissions / started, {0})",
        ...
        ["Aufrufe und Abschlussquote im Zeitraum {0}."] = "Views and completion rate over {0}.",
        ["Aufrufe"] = "Views",
