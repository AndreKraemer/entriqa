...
public static class ErrorMessages
{
    public const string
        ...
        RetentionActionInvalid = "retentionActionInvalid",
        RetentionAlreadyPermanent = "retentionAlreadyPermanent",
    ...
    private static readonly Dictionary<string, string> De = new()
    {
        ...
        [RetentionActionInvalid] = "Aufbewahrung muss 'retain', 'extend' oder 'lift' sein.",
        [RetentionAlreadyPermanent] = "Diese Einsendung wird bereits dauerhaft aufbewahrt.",
    ...
    private static readonly Dictionary<string, string> En = new()
    {
        ...
        [RetentionActionInvalid] = "Retention action has to be 'retain', 'extend' or 'lift'.",
        [RetentionAlreadyPermanent] = "This submission is already retained permanently.",
